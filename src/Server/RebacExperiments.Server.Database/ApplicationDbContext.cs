...
namespace RebacExperiments.Server.Database
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        /// <summary>
        /// Gets or sets the LocalizationRecords.
        /// </summary>
        public DbSet<LocalizationRecord> LocalizationRecords { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasSequence<int>("sq_LocalizationRecord", schema: "Application")
                .StartsAt(38187)
                .IncrementsBy(1);

            modelBuilder.Entity<LocalizationRecord>(entity =>
            {
                entity.ToTable("LocalizationRecord", "Application");

                entity.HasKey(e => e.Id);

                entity.Property(x => x.Id)
                    .HasColumnType("INT")
                    .HasColumnName("LocalizationRecordID")
                    .UseHiLo("sq_LocalizationRecord", "Application")
                    .ValueGeneratedOnAdd();

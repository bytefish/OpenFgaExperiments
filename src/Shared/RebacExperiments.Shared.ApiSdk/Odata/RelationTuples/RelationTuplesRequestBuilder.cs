...
#nullable enable
        public async Task<StoredRelationTupleCollectionResponse?> GetAsync(Action<RelationTuplesRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<StoredRelationTupleCollectionResponse> GetAsync(Action<RelationTuplesRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<StoredRelationTuple?> PostAsync(StoredRelationTuple body, Action<RelationTuplesRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<StoredRelationTuple> PostAsync(StoredRelationTuple body, Action<RelationTuplesRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(StoredRelationTuple body, Action<RelationTuplesRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(StoredRelationTuple body, Action<RelationTuplesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif

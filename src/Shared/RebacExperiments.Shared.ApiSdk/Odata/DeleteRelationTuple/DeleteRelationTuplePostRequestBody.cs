...
namespace RebacExperiments.Shared.ApiSdk.Odata.DeleteRelationTuple {
    public class DeleteRelationTuplePostRequestBody : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new DeleteRelationTuplePostRequestBody and sets the default values.
        /// </summary>
        public DeleteRelationTuplePostRequestBody() {
        ...
        public static DeleteRelationTuplePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DeleteRelationTuplePostRequestBody();
        }
        /// <summary>

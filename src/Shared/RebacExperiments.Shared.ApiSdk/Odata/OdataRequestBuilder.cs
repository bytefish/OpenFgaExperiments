...
using RebacExperiments.Shared.ApiSdk.Odata.CreateRelationTuple;
using RebacExperiments.Shared.ApiSdk.Odata.DeleteRelationTuple;
...
namespace RebacExperiments.Shared.ApiSdk.Odata {
    ...
    public class OdataRequestBuilder : BaseRequestBuilder {
        /// <summary>Provides operations to call the CreateRelationTuple method.</summary>
        public CreateRelationTupleRequestBuilder CreateRelationTuple { get =>
            new CreateRelationTupleRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Provides operations to call the DeleteRelationTuple method.</summary>
        public DeleteRelationTupleRequestBuilder DeleteRelationTuple { get =>
            new DeleteRelationTupleRequestBuilder(PathParameters, RequestAdapter);
        }

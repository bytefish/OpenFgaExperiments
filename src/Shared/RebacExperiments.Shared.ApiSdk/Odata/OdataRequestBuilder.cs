...
using RebacExperiments.Shared.ApiSdk.Odata.LoginGithub;
using RebacExperiments.Shared.ApiSdk.Odata.Me;
...
namespace RebacExperiments.Shared.ApiSdk.Odata {
    ...
    public class OdataRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Provides operations to call the login-github method.</summary>
        public LoginGithubRequestBuilder LoginGithub { get =>
            new LoginGithubRequestBuilder(PathParameters, RequestAdapter);
        }

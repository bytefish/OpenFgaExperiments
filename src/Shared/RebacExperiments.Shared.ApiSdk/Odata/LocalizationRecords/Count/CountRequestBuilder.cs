...
using System;
namespace RebacExperiments.Shared.ApiSdk.Odata.LocalizationRecords.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/LocalizationRecords/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CountRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/LocalizationRecords/$count{?%24search,%24filter}", rawUrl) {
        }
        /// <summary>

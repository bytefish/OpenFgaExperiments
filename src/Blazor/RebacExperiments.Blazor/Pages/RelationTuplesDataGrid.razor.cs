...
namespace RebacExperiments.Blazor.Pages
{
    public partial class RelationTuplesDataGrid
    {
        ...
        /// </summary>
        private GridItemsProvider<StoredRelationTuple> RelationTuplesProvider = default!;

        /// <summary>
        /// DataGrid.
        /// </summary>
        private FluentDataGrid<StoredRelationTuple> DataGrid = default!;
        ...
        protected override Task OnInitializedAsync()
        {
            RelationTuplesProvider = async request =>
            {
                ...
                if(response == null)
                {
                    return GridItemsProviderResult.From(items: new List<StoredRelationTuple>(), totalItemCount: 0);
                }
        ...
        private async Task<StoredRelationTupleCollectionResponse?> GetRelationTuples(GridItemsProviderRequest<StoredRelationTuple> request)
        {

...
$cmd = "${kiota_exe} generate --openapi ${param_openapi_schema} --language ${param_language} --namespace-name ${param_language} --log-level ${param_log_level} --output ${param_out_dir}"
